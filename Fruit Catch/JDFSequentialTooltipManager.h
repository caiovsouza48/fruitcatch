...
@protocol JDFSequentialTooltipManagerDelegate
 ...
 */
@property (nonatomic) UIImageView *kascoTutorialIM;


@property(nonatomic) id<JDFSequentialTooltipManagerDelegate> delegate;
