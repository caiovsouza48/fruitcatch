...
//  Fruit Catch
//
//  Created by Caio de Souza on 19/12/14.
...
- (void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event {
    if ([self isEnabled]) {
        IMP imp = [_targetTouchDown methodForSelector:_actionTouchDown];
        void (*func)(id,SEL) = (void *)imp;
        func(_targetTouchDown,_actionTouchDown);
...
- (void)touchesEnded:(NSSet *)touches withEvent:(UIEvent *)event {
    ...
    if ([self isEnabled] && CGRectContainsPoint(self.frame, touchPoint)) {
        [_targetTouchUpInside performSelector:_actionTouchUpInside withObject:nil afterDelay:0.0];
//        id (*typed_msgSend)(id, SEL) = (void *)objc_msgSend;
//        typed_msgSend(_targetTouchUpInside, _actionTouchUpInside);
